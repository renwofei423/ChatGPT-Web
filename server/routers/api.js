...
router.post('/chat/completions3', async (req, res) => {
    console.log('new completions...........................');
    console.time('newchat');
    const user_id = req?.user_id;
...
// --------------------end-----------------------------
// 对话
router.post('/chat/completions1', async (req, res) => {
    console.log('old completions...........................');
    console.time('chat');
    const user_id = req?.user_id;
    if (!user_id) {
        res.status(500).json((0, utils_1.httpBody)(-1, '服务端错误'));
